...
This project is a simple yet powerful calculator built with React. It offers basic arithmetic operations, trigonometric functions, and a user-friendly interface.
...
4. **Build for Production**
   ...
   This builds the app for production to the `build` folder. Your app is ready to be deployed!

## Usage

* Click on the number buttons to enter digits.
* Use the operation buttons (+, -, *, /) for basic arithmetic operations.
* Use the trigonometric function buttons (sin, cos, tan) for trigonometric calculations.
* Use the '%' button for percentage calculations.
* Click 'CE' to clear the current input.
